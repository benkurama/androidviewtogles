...
public class ViewToGLRenderer implements GLSurfaceView.Renderer{
    ...
    public void onSurfaceChanged(GL10 gl, int width, int height) {
        releaseSurface();
        mGlSurfaceTexture = createTexture10(gl);
    ...
    private int createTexture10(GL10 gl){
        int[] textures = new int[1];
        ...
        gl.glTexParameterf(GLES11Ext.GL_TEXTURE_EXTERNAL_OES, GL10.GL_TEXTURE_MIN_FILTER, GL10.GL_LINEAR);
